...
!******** Segment addition
          ...
          IF (IUT /= IU) THEN
            ...
            END IF
          END IF
          ! Reduced build no longer refreshes water-quality kinetics after branch activation.
...
!******** Segment subtraction
          ...
          IF (IUT /= IU) THEN
            ...
            END IF
          END IF
          ! Reduced build no longer refreshes water-quality kinetics after layer removal.
