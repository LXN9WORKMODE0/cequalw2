...
Module CEMASedimentDiagenesis   
  ...
  Subroutine SedimentPOM
    implicit none
    !
    real(R8) :: EPBurial, CLABILE,NLABILE,PLABILE,CCC,NNN,PPP
    integer  :: JJJ
    !
...
!
    ...
    Call CEMADisGasPhaseDistribution(SD1_Ammonia, SedTemp1, HenryConst_NH3, AmmoniaG_SD1, AmmoniaD_SD1)
    !Layer 2
    VolWater = CellArea(LayerNum,SegNumI)*SD_H2
    Call CEMADisGasPhaseDistribution(SD2_Ammonia, SedTemp2, HenryConst_NH3, AmmoniaG_SD2, AmmoniaD_SD2)
    !
    ! NO31 and NO32
...
!					
    ...
    IF(Bubbles_Calculation) THEN
		  ...
		  !Layer 1
      VolWater = CellArea(LayerNum,SegNumI)*SD_H1
		  Call CEMADisGasPhaseDistribution(SD1_Sulfide, SedTemp1, HenryConst_H2S, SulfideG_SD1, SulfideD_SD1)
		  !Layer 2
		  VolWater = CellArea(LayerNum,SegNumI)*SD_H2
		  Call CEMADisGasPhaseDistribution(SD2_Sulfide, SedTemp2, HenryConst_H2S, SulfideG_SD2, SulfideD_SD2)
...
!**** pH, carbon dioxide, bicarbonate, and carbonate concentrations
  ...
  Subroutine CEMADisGasPhaseDistribution(CTotal, GasTemp, HenryConst, CGasPh, CLiqPh)
    Use CEMAVars
    
    Real(R8) CTotal, GasTemp, HenryConst
    Real(R8) CGasPh, CLiqPh
