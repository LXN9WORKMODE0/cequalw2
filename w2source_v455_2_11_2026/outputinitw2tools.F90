    ...
    DO JW=1,NWB  
      IF (FLOWBALC=='      ON') THEN  
        ...
        IF(VOLUME_BALANCE(JW))THEN
            WRITE(FLOWBFN,'(a129)')'JDAY,WB,VOLIN(m3),VOLPR(m3),VOLOUT(m3),VOLWD(m3),VOLEV(m3),VOLDT(m3),VOLTRB(m3),VOLICE(m3),SurfaceArea(m2),Volume(m3),%VOLerror,'
        ELSE
            WRITE(FLOWBFN,'(a119)')'JDAY,WB,VOLIN(m3),VOLPR(m3),VOLOUT(m3),VOLWD(m3),VOLEV(m3),VOLDT(m3),VOLTRB(m3),VOLICE(m3),SurfaceArea(m2),Volume(m3),'
        ENDIF
        EXIT  
      ENDIF  
    ENDDO  
