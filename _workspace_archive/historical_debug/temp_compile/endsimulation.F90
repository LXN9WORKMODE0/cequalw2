...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  USE INITIALVELOCITY; USE TRIDIAG_V; USE MetFileRegion
  USE modSYSTDG, ONLY: DEALLOCATE_SYSTDG
  ...
  ! AlgaeReduceGasTransfer removed - algae related
  IMPLICIT NONE
...
!  DEALLOCATE (SSFLOC, FLOCEQN)                                                 
  ...
  DEALLOCATE (B2SP,   AGASSP, BGASSP, CGASSP, DGASSP, DGASGT, EQSP,   GASSPC, JBUSP,  JBDSP,  STRTPU, ENDPU,  EONPU,  EOFFPU, QPU,    PPUC)
  ...
  DEALLOCATE (Volume_WB, Surface_Area)
...
DEALLOCATE (LATERAL_PIPE)
  ...
  ! IF(REDUCE_GAS_TRANSFER)DEALLOCATE(I_ALG)  ! AlgaeReduceGasTransfer removed
  ...
  ! POROSITYC variables DEALLOCATE removed
...
! BIOENERGETICS module removed - 2026-03-31
...
ENDIF
  ...
  ! ENVIRPMOD module removed - 2026-03-31
