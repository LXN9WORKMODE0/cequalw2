...
SUBROUTINE PIPE_FLOW_INITIALIZE
  USE GLOBAL; USE GEOMC; USE STRUCTURES; USE SCREENC, ONLY: NIT, JDAY
  IMPLICIT NONE  
...
!c     is type1 flow
 ...
 REAL (R8) function t1func(FLOW,HEAD)                 !(flow,head)
     ...
     ! EXTERNAL DEPTHCRIT,BAREA
       REAL(R8)::HEAD,BAREA,DEPTHCRIT,FLOW
