...
CONTAINS
  ...
  SUBROUTINE UPDATE_TAIL_STAGE(JB_IN, JW_IN, ETA_INTERFACE_GUESS, Q_INTERFACE_COMMIT)
    ...
    CALL INVERT_TAIL_PROFILE_STORAGE(JB_IN, JW_IN, VOL_TARGET, TAIL_WSE_DN(JB_IN), WSE_STORAGE)
  ...
  SUBROUTINE COMPUTE_TAIL_MACRO_LINK_FLOW(JB_IN, JW_IN, IUP_SEG, IDN_SEG, WSE_UP, WSE_DN, &
    ...
    REAL(R8) :: WSE_LOCAL, AREA_LOCAL, HRAD_LOCAL, FMANN_LOCAL, RESIST_LOCAL
  ...
  SUBROUTINE INVERT_TAIL_PROFILE_STORAGE(JB_IN, JW_IN, TARGET_VOL, WSE_DN, WSE_OUT)
    INTEGER, INTENT(IN) :: JB_IN, JW_IN
    REAL(R8), INTENT(IN) :: TARGET_VOL, WSE_DN
    REAL(R8), INTENT(OUT) :: WSE_OUT
    REAL(R8) :: WLOW, WHIGH, WMID, VLOW, VHIGH, VMID
    INTEGER :: J
    ...
    DO J=1,60
      ...
      IF (ABS(VMID-TARGET_VOL) < 1.0D-3 .OR. ABS(WHIGH-WLOW) < 1.0D-8) EXIT
