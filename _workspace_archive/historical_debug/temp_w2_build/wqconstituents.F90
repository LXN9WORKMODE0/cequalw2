...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  ! MACROPHYTEC removed; USE POROSITYC; USE ZOOPLANKTONC;USE TRIDIAG_V
  USE ALGAE_TOXINS
  ...
  REAL :: TPALG,TNALG,TPZ,TNZ,TPBOD,TNBOD
      ...
      ! IF(MACROPHYTE_ON.AND.UPDATE_KINETICS)CALL POROSITY - MACROPHYTEC removed 
              ...
              DO JWD=1,JWW
                IF (QWD(JWD) /= 0.0) THEN
                  IF (JB == JBWD(JWD)) THEN
                    ...
                    DO K=KTW(JWD),KBW(JWD)      !CONCURRENT(K=KTW(JWD):KBW(JWD))                
