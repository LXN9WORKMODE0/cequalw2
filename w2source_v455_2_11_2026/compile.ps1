...
Set-Location "C:\Users\NING\Desktop\v455\w2source_v455_2_11_2026"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Output: $moddir\w2_v455_ifx.exe"
} else {
    Write-Host "BUILD FAILED"
    Write-Host "Check $moddir\build.log for errors"
}