...
! Title and array dimensions
  ...
  READ (CON,'(//8X,I8,7A8,f8.0)')  NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,inituwl,ORGCC,DZMAX     !, SYSTDGC, N2BNDC, DOBNDC, TDGTAC       ! systdg - Add control variables
  ELSE
  READ (CON,*)
  READ (CON,*)
  READ (CON,*)
  ...
  READ (CON,*)
  READ (CON,*)
  READ (CON,*) NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,INITUWL,ORGCC,DZMAX           !'(I0,5(A))'
