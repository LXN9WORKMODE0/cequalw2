...
!  ALLOCATE (HYDRO_PLOT(NHY),    CONSTITUENT_PLOT(NCT), DERIVED_PLOT(NDC))
  ...
  ALLOCATE (TAIL_DOMAIN_US(NBR), TAIL_DOMAIN_DS(NBR), TAIL_DOMAIN_NSEG(NBR), TAIL_FIXED_MIN_NSEG(NBR))
  ALLOCATE (TAIL_MACRO_INTERFACE_SEG(NBR), TAIL_MACRO_ACTIVE_SEG(NBR))
  ...
  ALLOCATE (TAIL_MACRO_ACTIVE_MANNING(NBR))
  ...
  ALLOCATE (TAIL_RESERVOIR_Q_USED(NBR), TAIL_STORAGE_CHANGE_RATE(NBR), TAIL_MASS_RESIDUAL(NBR), TAIL_SEGMENT_Q_LOSS(NBR))
  ALLOCATE (TAIL_MASS_RESIDUAL_MAX(NBR), TAIL_FLUX_GAP_MAX(NBR), TAIL_COMBINED_MASS_RESIDUAL_MAX(NBR), TAIL_SEGMENT_Q_LOSS_MAX(NBR))
