...
Module Fishy
      ...
      REAL(R8) ::  VALUE,GRADXVEL,GRADZVEL,GRADTEMP,GRADDO
      REAL(R8) ::  XGRADHV,ZGRADHV,XGRADVV,ZGRADVV
      REAL(R8) ::  XGRADDO,ZGRADDO,XGRADTP,ZGRADTP
      REAL(R8) ::  FXVEL,FZVEL,FISHTEMP,FISHDO,TEMPORARYGRAD
      REAL(R8) ::  FXHVCOUNT,FXVVCOUNT,FXDOCOUNT,FXTPCOUNT,FXRDCOUNT,TOTFXWGT
      REAL(R8) ::  FZHVCOUNT,FZVVCOUNT,FZDOCOUNT,FZTPCOUNT,FZRDCOUNT,TOTFZWGT
      REAL(R8) ::  FX00COUNT,FZ00COUNT,nfsfreq,RUNDIFF
...
!  This Subroutine Calls No Other Subroutines
      ...
      NN = 0                                                       ! NN = Global Node # (UpperLeft Corner of cell(K,I))
        ! WB = Water Body # / NWB = Total # of Water Bodies
      DO WB=1,NWB
        ! JB = Branch #
          DO JB=BS(WB),BE(WB)
      ! K = Layer #
...
character*3 ALINE
INTEGER :: I,J,NA, IDEBUG, NFISHLAST,ILINEAR,HTSTBOT,HTSTSIDE
...
! Compute passive particle transport including sedimentation
    ...
    REAL :: DXMIN=0.0005, DZMIN1=0.0001,DZMAX1=0.5, COSTHETA, SINTHETA, DX1, DX2, DXAVG, RZ, RX, DZ1, DZ2, DZAVG, r1, r2
    REAL :: DISPX, DISPZ, VEL
