...
USE GLOBAL;     USE NAMESC; USE GEOMC;  USE LOGICC; USE PREC;  USE SURFHE;  USE KINETIC; USE SHADEC; USE EDDY
  ...
  ! USE KINETIC kept - CAC used for constituent checks
  ! USE TDGAS removed - not used directly
  USE modSYSTDG  ! SYSTDG procedures still needed for linking
  ...
  REAL(R8)  :: TSUM,QSUMM
  LOGICAL, DIMENSION(NGT) :: GTNAME  ! systdg - local declaration since modSYSTDG removed
!***********************************************************************************************************************************
